var TEMPLATES = (function () {
	...
	function home() {
		...
		var html_str = '';
		html_str += '<section>';
		html_str += '<h2>Welcome Community Members!</h2>';
		html_str += '<p>';
		html_str += 'This year, you will be learning to identify different kinds of birds. Whenever you spot a bird, you will save your sighting details in the bird sightings log. The more you look, the more birds you will notice. You may be surprised how many you can spot around your home, local, parks, or even inside a store!';
		html_str += '</p><p>';
